...
public class LiveDataCallAdapterFactory extends CallAdapter.Factory {
    ...
    /**
     * This method performs a number of checks and then returns the Response type for Retrofit request
     * (@bodyType is the ResponseType. If can be RecipeResponse or RecipeSearchResponse)
